...
if __name__ == '__main__':
    ...
    list_Exp_ID = ['501271265', '501836392' , '501704220', '502115959' ,'502205092', '504637623', '510514474', '510517131','540684467', '545446482' ]
    ...
    dir_selected = dir_parent + 'SelectedMasks\\' 
    ...
    if not os.path.exists(dir_selected):
    ...
    thresh_mask = 0.5
    # maximum COM distance of two masks to be considered the same neuron
    #in the initial merging (unit: pixels in ABO videos)
    thresh_COM0 = 2
   ...
   # list_thresh_COM = [6] 
    ...
    for CV in range(0,nvideo):
        ...
        file_CNN2 = weights_path+'Model2_CV{}.h5'.format(CV)
        file_CNN3 = weights_path+'Model3_CV{}.h5'.format(CV)
